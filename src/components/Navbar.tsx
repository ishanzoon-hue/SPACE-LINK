    ...
    return (
        <header className="bg-white dark:bg-[#0F172A] border-b border-gray-200 dark:border-gray-800 sticky top-0 z-50 transition-colors">
            <div className="max-w-5xl mx-auto px-2 sm:px-4 h-16 flex items-center justify-between gap-1 sm:gap-4">
                ...
                <Link href="/" className="shrink-0 transition-opacity hover:opacity-80">
                    <div className="flex items-center">
                        <svg 
                            ...
                            className="hover:scale-105 transition-transform duration-300 w-20 sm:w-40 h-auto"
                        >
                ...
                {/* 2. Search Bar - ෆෝන් එකේදි පොඩි වෙන විදිහට හැදුවා */}
                <div className="flex-1 min-w-[100px] max-w-[130px] sm:max-w-sm mx-1 sm:mx-4">
                    <SearchBar />
                </div>

                {/* 3. Action Icons - ෆෝන් එකේදි Swipe කරන්න පුළුවන්! */}
                <div 
                    className="flex items-center gap-1.5 sm:gap-4 shrink-0 overflow-x-auto no-scrollbar pb-1 pt-1"
                ...
                >
                    ...
                    {user ? (
                        <>
                            <Link href="/" className="p-1 text-gray-500 hover:text-spl-green dark:text-gray-400 shrink-0">
                            ...
                            <Link href="/messages" className="p-1 text-gray-500 hover:text-spl-green dark:text-gray-400 shrink-0">
                            ...
                            <Link href={`/profile/${user.id}`} className="p-1 text-gray-500 hover:text-spl-green dark:text-gray-400 shrink-0">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                            <ThemeToggle />
                            <SettingsToggle /> 
                            <Link href="/login" className="text-xs font-semibold px-2 py-2 whitespace-nowrap">Log in</Link>
                            <Link href="/signup" className="text-xs font-bold bg-spl-green text-white px-3 py-2 rounded-lg whitespace-nowrap">Sign up</Link>
                        </div>
                    )}
                </div>
            </div>
